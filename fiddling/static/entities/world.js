...
export class World {
	...
	var weapon1 = new Cannon(player, 1, 0.5, 0.05, 100, 15)
	var weapon2 = new Cannon(player, 1, -0.5, -0.05, 100, 15)
	var weapon3 = new MissileLauncher(player, 1, 0., 0., 5000, 5)
	var shield = new Shield(player, 3, 100, 0.01, 5000)
